...
# User inputs
apikey = 'd14f048bce24499d985a79123bc88827'  # api key in ''
raid = 'Sepulcher of the First Ones'  # raid name in ''
dificulty = 4  # 1 = LFR, 2 = Flex, 3 = Normal, 4 = Heroic, 5 = Mythic, 10 = Challenge Mode
